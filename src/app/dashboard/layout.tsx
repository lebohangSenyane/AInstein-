...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { href: "/dashboard/chat", icon: MessageSquare, label: "Chat Tutor" },
    { href: "/dashboard/vision-lab", icon: Eye, label: "Vision Lab" },
    { href: "/dashboard/live-tutor", icon: Mic, label: "Live Tutor" },
  ];
    ...
    <aside className="fixed inset-y-0 left-0 z-10 hidden w-14 flex-col border-r bg-background sm:flex">
      <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
        ...
        >
          ...
          <span className="sr-only">AInstein</span>
        </Link>
        <TooltipProvider>
          {navItems.map((item) => (
      ...
      <nav className="mt-auto flex flex-col items-center gap-4 px-2 sm:py-5">
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent side="right">System Health</TooltipContent>
          </Tooltip>
        </TooltipProvider>
        <TooltipProvider>
          <Tooltip>
